...
<h3 align="center">Salas imersivas</h3>
  ...
  <p align="center"><img src="../../../geometria-descritiva/videos/selfintersectsnub1.gif" style="max-width: 31.5%; border-radius:5px; margin-right:5%" loading="lazy" alt="Sala imersiva dos poliedros truncados de auto-interseção snubficados"/><img src="../../../geometria-descritiva/videos/selfintersectsnub2.gif" style="max-width: 31.5%; border-radius:5px; margin-right:5%" loading="lazy" alt="Sala imersiva dos poliedros truncados de auto-interseção snubficados"/><img src="../vr/salas/videos/selfintersectsnub.gif" style="max-width: 31.5%; border-radius:5px" loading="lazy" alt="Sala imersiva dos poliedros truncados de auto-interseção snubficados"/></p>
<hr>
